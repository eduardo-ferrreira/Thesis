...
y_taylor = np.array(df1['position'])
t_taylor = np.array(df1['t fall'])
...
plt.scatter(t_taylor,y_taylor, label='Taylor 1$^{st}$ order', color='tab:orange')
plt.plot(t_taylor,y_taylor*100,color='tab:orange')#, label='Taylor 1$^{st}$ order')
...
y1=np.array(0.427)
y2=np.array(0.467)
plt.fill_between(x=[0.430,0.470], y1=0, y2=101, where=[0.430,0.470], color='C1', alpha=0.3, label='RPI data interval')
plt.legend()
